...
exports.register = function (plugin, options, next) {
  ...
  if (Hoek.reach(settings, 'basePath')) {
    routePrefix = Hoek.reach(settings, 'basePath') + routePrefix;
  }
  ...
  var internals = {
    handler: function (request, reply) {
      ...
      if (settings.swaggerEndpoint) {
        ...
        if (Hoek.reach(settings, 'basePath')) {
          swaggerEndpoint = Hoek.reach(settings, 'basePath') + swaggerEndpoint;
        }
      }
      var context = {
      ...
      if (swaggerEndpoint) {
        ...
        if (Hoek.reach(settings, 'basePath')) {
          swaggerOptions.basePath = Hoek.reach(settings, 'basePath');// + swaggerEndpoint;
        }
